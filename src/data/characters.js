...
const BASE_CHARACTERS = [
  ...
  },
  {
    ...
    name: '셀카 글룸베일',
    jobId: 'warlock',
    skillId: 'gloom-ritual',
    portraitId: 'selka',
    spriteId: 'selka',
    rarity: 'common',
    signatureTraitId: 'spirit-drawn',
    traitPool: ['night-harvest', 'void-channel'],
    statAdjustments: { spellPower: 12, mana: 18 },
    biography: '음침한 장막 속에서 저주와 흡수를 반복하는 거리의 흑술사.',
  },
  {
    id: 'mirra-skyguard',
    name: '미라 스카이가드',
  ...
  {
    id: 'caela-prismweaver',
    name: '카엘라 프리즘위버',
    jobId: 'mage',
    skillId: 'glacial-prism',
    portraitId: 'caela',
    spriteId: 'caela',
    rarity: 'uncommon',
    signatureTraitId: 'arcane-battery',
    traitPool: ['arc-light', 'deep-focus'],
    statAdjustments: { spellPower: 22, mana: 26, speed: 0.01 },
    biography: '빛과 얼음을 굴절시켜 적을 빙결시키는 비전 유리공.',
  },
  {
    id: 'draven-longshot',
    name: '드레이븐 롱샷',
  ...
  },
  {
    ...
    name: '락센 스톤가드',
    jobId: 'warrior',
    skillId: 'tremor-guard',
    portraitId: 'raxen',
    spriteId: 'raxen',
    rarity: 'uncommon',
    signatureTraitId: 'guardian-pulse',
    traitPool: ['life-draught', 'obsidian-guard'],
    statAdjustments: { health: 140, attack: 8, defense: 6 },
    biography: '지면을 울리는 방패 강타로 아군 전열을 지키는 방패병.',
  },
  {
    id: 'sorin-ironveil',
    name: '소린 아이언베일',
  ...
  },
  {
    ...
    name: '셀라 문마크',
    jobId: 'archer',
    skillId: 'moonlight-salvo',
    portraitId: 'shelar',
    spriteId: 'shelar',
    rarity: 'rare',
    signatureTraitId: 'howling-gale',
    traitPool: ['swift-arrows', 'arc-light'],
    statAdjustments: { attack: 16, range: 60, speed: 0.03 },
    biography: '달빛을 화살촉에 담아 먼 거리에서도 표적을 꿰뚫는 귀족 사수.',
  },
  {
  ...
  {
    id: 'elyndra-graceborn',
    name: '엘린드라 그레이스본',
    jobId: 'consecrator',
    skillId: 'luminous-veil',
    portraitId: 'elyndra',
    spriteId: 'elyndra',
    rarity: 'unique',
    signatureTraitId: 'celestial-aegis',
    traitPool: ['radiant-song', 'moon-ward'],
    statAdjustments: { mana: 38, spellPower: 18, defense: 6 },
    biography: '신성한 장막으로 전선을 감싸는 황실 주교.',
  },
  {
    id: 'velis-aurorist',
    name: '벨리스 오로리스트',
    jobId: 'mage',
    skillId: 'prismatic-surge',
    portraitId: 'velis',
    spriteId: 'velis',
    rarity: 'unique',
    signatureTraitId: 'arcane-battery',
    traitPool: ['deep-focus', 'arc-light'],
    statAdjustments: { spellPower: 32, mana: 44, speed: 0.02 },
    biography: '프리즘 마법으로 빛의 스펙트럼을 폭발시키는 황금 연금술사.',
  },
  {
  ...
  },
  {
    ...
    name: '갈렌 스타시지',
    jobId: 'knight',
    skillId: 'aurora-bulwark',
    portraitId: 'galen',
    spriteId: 'galen',
    rarity: 'epic',
    signatureTraitId: 'stone-bulwark',
    traitPool: ['celestial-aegis', 'guardian-pulse'],
    statAdjustments: { health: 260, defense: 24, mana: 20 },
    biography: '성좌의 문장을 새긴 방패로 전장을 밝히는 성기사단장.',
  },
];
